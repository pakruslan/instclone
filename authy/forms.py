...
class SignupForm(forms.ModelForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['username'].validators.append(forbidden_users_f)
		self.fields['username'].validators.append(invalid_user_i)
		self.fields['username'].validators.append(unique_user_u)
		self.fields['email'].validators.append(unique_email_u)
